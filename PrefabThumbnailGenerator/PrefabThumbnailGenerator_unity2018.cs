...
// Version 1.0.0 (for Unity 2018) on June 14, 2025.
/*
...
{
    public class PrefabThumbnailGenerator_2018 : EditorWindow
    {
        ...
        {
            GetWindow<PrefabThumbnailGenerator_2018>("Prefab Thumbnail Generator");
        }
        void OnGUI()
        {
            ...
            // ModifyTextureImportSettings_2018 onPop = new ModifyTextureImportSettings_2018();
            // onPop.OnMenu();
        ...
        void SaveThumbnail(Object prefab, string _savePath)
        {
            ...
            ModifyTextureImportSettings_2018 textureSet = new ModifyTextureImportSettings_2018(){type = targetType,
